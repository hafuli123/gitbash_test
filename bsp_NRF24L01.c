...
const uint8_t TX_ADDRESS[TX_ADR_WIDTH]={0xac, 0x00, 0x00, 0x00, 0x01}; //发送地址
const uint8_t RX_ADDRESS[RX_ADR_WIDTH]={0xac, 0x00, 0x00, 0x00, 0x01};
...
void NRF24L01_SPI_Init(void)
{
  ...
  hspi_NRF24L01.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_8;
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==NRF24L01_SPIx)
  {
    ...
    NRF24L01_SPI_MSS_ClK_ENABLE();
    NRF24L01_SPI_SCK_ClK_ENABLE();
    ...
    */
    ...
    HAL_GPIO_Init(NRF24L01_SPI_SCK_PORT, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = NRF24L01_SPI_MISO_PIN|NRF24L01_SPI_MOSI_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    HAL_GPIO_Init(NRF24L01_SPI_MSS_PORT, &GPIO_InitStruct);
