...
#define NRF24L01_SPI_SCK_ClK_ENABLE()                 __HAL_RCC_GPIOA_CLK_ENABLE()
#define NRF24L01_SPI_SCK_PORT                         GPIOA
#define NRF24L01_SPI_SCK_PIN                          GPIO_PIN_5

#define NRF24L01_SPI_MSS_ClK_ENABLE()                __HAL_RCC_GPIOA_CLK_ENABLE()
#define NRF24L01_SPI_MSS_PORT                         GPIOA
